...
Histo::Book()
{
  ...
  G4cout << "### Histo::Save: Opended file <" << nam << ">  for " << fNHisto << " histograms " << G4endl;
...
void
Histo::Add1D(const G4String & id, const G4String & name, G4int nb, G4double x1, G4double x2, G4double u)
{
  if (fVerbose > 0)
  {
...
void
Histo::Activate(G4int i, G4bool val)
{
  if (fVerbose > 1)
  {
...
void
Histo::Fill(G4int i, G4double x, G4double w)
{
  if (!fHistoActive)
  {
    return;
...
void
Histo::ScaleH1(G4int i, G4double x)
{
  if (!fHistoActive)
  {
    return;
...
void
Histo::AddTuple(const G4String & w1)
{
  fTupleTitle = w1;
}
...
void
Histo::AddTupleI(const G4String & w1)
{
  fNtupleActive = true;
...
void
Histo::AddTupleF(const G4String & w1)
{
  fNtupleActive = true;
...
void
Histo::AddTupleD(const G4String & w1)
{
  fNtupleActive = true;
...
void
Histo::FillTupleI(G4int i, G4int x)
{
  if (!fNtupleActive)
  {
    return;
...
void
Histo::FillTupleF(G4int i, G4float x)
{
  if (!fNtupleActive)
  {
    return;
...
void
Histo::FillTupleD(G4int i, G4double x)
{
  if (!fNtupleActive)
  {
    return;
...
void
Histo::SetFileName(const G4String & nam)
{
  fHistName = nam;
  fHistoActive = true;
}
...
void
Histo::SetFileType(const G4String & nam)
{
