...
foreach(subdir ${DOCSUBDIRS})
  file(
    ...
    RELATIVE "${PCT_SOURCE_DIR}"
    "${PCT_SOURCE_DIR}/${subdir}/*"
  )
...
file(GLOB_RECURSE content_files "${PCT_DOC_OUTPUT_DIR}/*${link_content}")
foreach(content_file ${content_files})
  ...
  if(
    NOT
      EXISTS
        "${PCT_DOC_OUTPUT_DIR}/${content_file_rel_path}"
    OR
      NOT
        "${PCT_DOC_OUTPUT_DIR}/${content_file_rel_path}"
          IS_NEWER_THAN
