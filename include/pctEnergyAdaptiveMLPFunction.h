...
/** \class FactorsABCD
 * \ingroup PCT
 * Class which calculates factor A, B, C, D as in Eq. 7-10 in [Krah, PMB, 2021].
 */
class FactorsABCD
{
public:
...
/** \class CoefficientsC
 * \ingroup PCT
 * Class which calculates factors c0 and c1 as in Eq. 15 in [Krah, PMB, 2019].
 */
class CoefficientsC
{
public:
 ...
 * Energy-adaptive calculation of the most likely path [Krah, PMB, 2021].
 */
